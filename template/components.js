var DevDocs = (function (e) {
  ...
  function O(e) {
    ((!e.__d && (e.__d = !0) && i.push(e) && !k.__r++) ||
      ...
      ((a = n.debounceRendering) || o)(k);
  }
  function k() {
    try {
      for (var e, t = 1; i.length; )
        (i.length > t && i.sort(s), (e = i.shift()), (t = i.length), E(e));
    } finally {
      i.length = k.__r = 0;
    }
  }
  function ee(e, t, n, r, i, a, o, s, c, l, u) {
    ...
    for (c = A(n, t, b, c, x), d = 0; d < x; d++)
      (p = n.__k[d]) != null &&
        ...
        p.ref &&
          f.ref != p.ref &&
          (f.ref && L(f.ref, null, p), u.push(p.ref, p.__c || m, p)),
        _ == null && m != null && (_ = m),
        (y = !!(4 & p.__u)) || f.__k === p.__k
          ? ((c = j(p, c, e, y)), y && f.__e && (f.__e = null))
      ...
      (o = t[a]) != null && typeof o != `boolean` && typeof o != `function`
        ? (typeof o == `string` ||
          ...
          o.constructor == String
            ? (o = e.__k[a] = S(null, o, null, null, null))
            : v(o)
              ? (o = e.__k[a] = S(C, { children: o }, null, null, null))
  ...
  function P(e, t, r, i, a, o, s, c, l, u) {
    var d,
      f,
      p,
      m,
    ...
    n: if (typeof M == `function`)
      try {
        if (
          ((S = t.props),
          (T = M.prototype && M.prototype.render),
          (E = (d = M.contextType) && i[d.__c]),
          (D = d ? (E ? E.props.value : d.__) : i),
          r.__c
            ? (x = (f = t.__c = r.__c).__ = f.__E)
            : (T
                ? (t.__c = f = new M(S, D))
                : ((t.__c = f = new w(S, D)),
                  (f.constructor = M),
              ...
              (f.__h = []),
              (f._sb = [])),
          T && f.__s == null && (f.__s = f.state),
          T &&
            M.getDerivedStateFromProps != null &&
            (f.__s == f.state && (f.__s = y({}, f.__s)),
            y(f.__s, M.getDerivedStateFromProps(S, f.__s))),
          (m = f.props),
          (h = f.state),
          (f.__v = t),
          p)
          ...
          if (
            (T &&
              ...
              f.componentWillReceiveProps(S, D),
            t.__v == r.__v ||
              (!f.__e &&
                f.shouldComponentUpdate != null &&
                !1 === f.shouldComponentUpdate(S, f.__s, D)))
          ) {
            (t.__v != r.__v && ((f.props = S), (f.state = f.__s), (f.__d = !1)),
              (t.__e = r.__e),
              (t.__k = r.__k),
          ...
          (f.componentWillUpdate != null && f.componentWillUpdate(S, f.__s, D),
            T &&
        ...
        ((f.state = f.__s),
          ...
          (A =
            d != null && d.type === C && d.key == null
              ? re(d.props.children)
              : d),
          (c = ee(e, v(A) ? A : [A], t, r, i, a, o, s, c, l, u)),
          (f.base = t.__e),
          (t.__u &= -161),
          f.__h.length && s.push(f),
          x && (f.__E = f.__ = null));
        ...
        else ((t.__e = r.__e), (t.__k = r.__k), e.then || F(t));
        n.__e(e, t, r);
      }
    else
      o == null && t.__v == r.__v
        ? ((t.__k = r.__k), (t.__e = r.__e))
        : (c = t.__e = ie(r.__e, t, r, i, a, o, s, l, u));
  ...
  function ie(e, r, i, a, o, s, c, l, u) {
    ...
    if (e == null) {
      ...
      ((e = document.createElementNS(o, C, S.is && S)),
        (l &&= (n.__m && n.__m(r, s), !1)),
        (s = null));
    }
    if (C == null) x === S || (l && e.data == S) || (e.data = S);
      ...
      if (
        ...
        for (x = {}, d = 0; d < e.attributes.length; d++)
          x[(g = e.attributes[d]).name] = g.value;
      for (d in x)
        ((g = x[d]),
  ...
  function ae(e, t, r) {
    ...
    if (
      ...
      (i = e.ref) && ((i.current && i.current != e.__e) || L(i, null, t)),
      (i = e.__c) != null)
    ) {
    ...
    if ((i = e.__k))
      for (a = 0; a < i.length; a++)
        i[a] && ae(i[a], t, r || typeof e.type != `function`);
  ...
  function ce(e, n, r) {
    ...
    return (
      arguments.length > 2 &&
        (c.children = arguments.length > 3 ? t.call(arguments, 2) : r),
      S(e.type, c, i || e.key, a || e.ref, null)
    );
  }
  ((t = g.slice),
    (n = {
    ...
    (w.prototype.setState = function (e, t) {
      ...
      (typeof e == `function` && (e = e(y({}, n), this.props)),
        e && y(n, e),
        e != null && this.__v && (t && this._sb.push(t), O(this)));
    }),
    (w.prototype.forceUpdate = function (e) {
      this.__v && ((this.__e = !0), e && this.__h.push(e), O(this));
    }),
    (w.prototype.render = C),
    (i = []),
    (o =
  ...
  var ue = [`context`, `children`],
    de = [`useFragment`];
  function B(e, t, n, r) {
    function i() {
      var t,
        n = Reflect.construct(HTMLElement, [], i);
      return (
        (n._vdomComponent = e),
        r && r.shadow
          ? ((n._root = n.attachShadow({
              mode: r.mode || `open`,
              serializable: (t = r.serializable) != null && t,
            })),
            r.adoptedStyleSheets &&
              (n._root.adoptedStyleSheets = r.adoptedStyleSheets))
          : (n._root = n),
        n
      );
    }
    return (
      ...
      (i.prototype.attributeChangedCallback = he),
      (i.prototype.disconnectedCallback = ge),
      (n = n || e.observedAttributes || Object.keys(e.propTypes || {})),
      (i.observedAttributes = n),
      e.formAssociated && (i.formAssociated = !0),
  ...
  function pe(e) {
    ...
    (this.dispatchEvent(t),
      (this._vdom = x(
        fe,
        z({}, this._props, { context: t.detail.context }),
        ve(this, this._vdomComponent, e),
      )),
      (this.hasAttribute(`hydrate`) ? se : R)(this._vdom, this._root));
  }
  function me(e) {
  ...
  function ve(e, t, n) {
    ...
    for (a = o.length; a--; )
      o[a].name !== `slot` &&
        ((i[o[a].name] = o[a].value), (i[me(o[a].name)] = o[a].value));
    for (a = s.length; a--; ) {
      var c = ve(s[a], null, n),
        l = s[a].slot;
      l ? (i[l] = x(_e, { name: l }, c)) : (r[a] = c);
    }
    var u = !(!n || !n.shadow),
      d = t ? x(_e, { useFragment: !u }, r) : r;
    return (
      !u && t && (e.innerHTML = ``),
      x(t || e.nodeName.toLowerCase(), i, d)
    );
  }
  var V,
    H,
  ...
  function ke() {
    for (var e; (e = be.shift()); ) {
      ...
      if (e.__P && t)
        try {
          (t.__h.some(J), t.__h.some(Y), (t.__h = []));
        } catch (n) {
          ((t.__h = []), G.__e(n, e.__v));
        }
    }
    ...
    (G.__r = function (e) {
      ...
      (t &&
        (U === H
          ...
          : (t.__h.some(J), t.__h.some(Y), (t.__h = []), (V = 0))),
        (U = H));
    }),
    (G.diffed = function (e) {
      Ce && Ce(e);
      ...
      (t &&
        t.__H &&
        (t.__H.__h.length &&
          ((be.push(t) !== 1 && ye === G.requestAnimationFrame) ||
            ((ye = G.requestAnimationFrame) || Ae)(ke)),
  ...
  function Z({
    ...
    let [o, s] = K(!0);
    if (!o) return null;
    let c = `border-blue-100 dark:border-blue-900/30`,
      l = `bg-blue-50/40 dark:bg-blue-950/10`,
      u = `text-blue-900 dark:text-blue-200`,
      d = `text-blue-600 dark:text-blue-400`,
      f = `info`,
      p = n === !0 || n === `true` || n === ``;
    switch (e) {
      case `warning`:
        ((c = `border-amber-100 dark:border-amber-900/30`),
          (l = `bg-amber-50/40 dark:bg-amber-950/10`),
          (u = `text-amber-900 dark:text-amber-200`),
          (d = `text-amber-600 dark:text-amber-400`),
          (f = `alert-triangle`));
        break;
      case `success`:
        ((c = `border-emerald-100 dark:border-emerald-900/30`),
          (l = `bg-emerald-50/40 dark:bg-emerald-950/10`),
          (u = `text-emerald-900 dark:text-emerald-200`),
          (d = `text-emerald-600 dark:text-emerald-400`),
          (f = `check-circle-2`));
        break;
      case `danger`:
      case `error`:
        ((c = `border-red-100 dark:border-red-900/30`),
          (l = `bg-red-50/40 dark:bg-red-950/10`),
          (u = `text-red-900 dark:text-red-200`),
    ...
    return (
      ...
      X(`div`, {
        className: `block my-4 transition-all duration-300 ${r}`,
        children: X(`div`, {
          className: `relative flex gap-3 p-4 rounded-xl border ${c} ${l} ${u}`,
          children: [
            X(`i`, {
              "data-lucide": m,
              className: `w-5 h-5 ${d} shrink-0 mt-0.5`,
            }),
            X(`div`, {
              ...
              children: [
                ...
                X(`div`, {
                  className: `leading-relaxed content-area`,
                  children:
                    typeof a == `string`
                      ? X(`span`, { dangerouslySetInnerHTML: { __html: a } })
                      : a,
                }),
              ],
            }),
            p &&
              X(`button`, {
                ...
                children: X(`i`, { "data-lucide": `x`, className: `w-4 h-4` }),
              }),
          ],
        }),
      })
  ...
  function Q({ title: e = ``, open: t = !1, children: n }) {
    let [r, i] = K(t === !0 || t === `true` || t === ``);
    return (
      window.lucide &&
        typeof window.lucide.createIcons == `function` &&
        setTimeout(() => window.lucide.createIcons(), 0),
      X(`div`, {
        className: `border border-slate-200 dark:border-slate-800/80 rounded-xl overflow-hidden bg-white dark:bg-slate-900 transition-all duration-300 my-2`,
        children: [
          X(`button`, {
            onClick: () => i(!r),
            ...
            children: [
              ...
              X(`i`, {
                ...
                className: `w-4 h-4 text-slate-500 dark:text-slate-400 transition-transform duration-300 shrink-0 ${r ? `rotate-180` : ``}`,
              }),
            ],
          }),
          X(`div`, {
            className: `transition-all duration-350 ease-in-out overflow-hidden ${r ? `max-h-[1000px] border-t border-slate-100 dark:border-slate-800/40` : `max-h-0`}`,
            children: X(`div`, {
              className: `p-4 text-sm text-slate-600 dark:text-slate-400 leading-relaxed content-area`,
              children:
                typeof n == `string`
                  ? X(`span`, { dangerouslySetInnerHTML: { __html: n } })
                  : n,
            }),
          }),
        ],
  ...
  function $({ language: e = `plaintext`, code: t = `` }) {
    let [n, r] = K(!1);
    return (
      window.lucide &&
        typeof window.lucide.createIcons == `function` &&
        setTimeout(() => window.lucide.createIcons(), 0),
      X(`div`, {
        className: `relative group my-4 rounded-xl overflow-hidden border border-slate-800 bg-slate-950 text-slate-200 font-mono text-sm shadow-md`,
        children: [
          X(`div`, {
            className: `flex items-center justify-between px-4 py-2 border-b border-slate-900 bg-slate-900/60 text-xs text-slate-400 select-none`,
            children: [
              X(`span`, {
              ...
              X(`button`, {
                ...
                children: [
                  X(`i`, {
                    "data-lucide": n ? `check` : `copy`,
                    className: `w-3.5 h-3.5`,
                  }),
                  X(`span`, { children: n ? `Copied!` : `Copy` }),
                ],
              }),
            ],
          }),
          X(`pre`, {
            className: `p-4 overflow-x-auto m-0 leading-relaxed font-mono text-xs sm:text-sm`,
            children: X(`code`, { children: t }),
          }),
        ],
      })
    );
  ...
  return (
    B(Z, `docs-alert`, [`type`, `title`, `dismissible`, `className`, `icon`], {
      shadow: !1,
    }),
    B(Q, `docs-accordion`, [`title`, `open`], { shadow: !1 }),
    B($, `docs-code-block`, [`language`, `code`], { shadow: !1 }),
    (window.DevDocs = {
      Alert: (e) => {
        let t = document.createElement(`div`);
        return (R(x(Z, { ...e }), t), t.firstElementChild || t);
      },
      Accordion: (e) => {
        let t = document.createElement(`div`);
        return (R(x(Q, e), t), t.firstElementChild || t);
      },
      CodeBlock: (e) => {
        let t = document.createElement(`div`);
        return (R(x($, e), t), t.firstElementChild || t);
      },
    }),
    (e.Accordion = Q),
    (e.Alert = Z),
